...
<div class="inner-block">
  ...
  $query=mysqli_query($koneksi, "SELECT * FROM outlet WHERE Kode_outlet='$kdo'");
  while ($q = mysqli_fetch_array($query)) {
    ?>
       <form action="update_dtoutlet.php" method="post">
              <font face="Cambria Math"> 
              <table class="table table-hover">
              <tr>
              <td>Kode Outlet</td>
              <td><input type="text" size="20" name="Kode_outlet" class="form-control" readonly="" value="<?php echo $q['Kode_outlet'];?>"></td>
              </tr>  
              <tr>
              <td>Nama Outlet</td>
              <td><input type="text" name="Nama_outlet" size="20" placeholder="Masukan Nama" class="form-control" required="required" value="<?php echo $q['Nama_outlet'];?>"></td>
              </tr>  
              <tr>
              <td>Alamat</td>
