...
<div class="inner-block">
    <div class="blank">
    	<center><h2><font face="Cambria Math">Laporan Data Omset</font></h2></center>	

  <font face="Cambria Math">
  <div class="row">
    <div class="col-md-2">
  <form action="cetakom2.php">
 ...
 <?php
    include 'koneksi.php';
    $tgl = date('Y-m-d');
    $query = mysqli_query($koneksi, "SELECT SUM(Total) as Omset FROM transaksi WHERE transaksi.Tgl_dtg='$tgl'");
...
<div class="modal fade" id="smallModal1" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="cetakom2.php">
