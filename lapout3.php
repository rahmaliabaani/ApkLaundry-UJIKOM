...
<font face="Cambria Math">
  <div class="inner-block">
    <div class="blank">
      <center><h2><font face="Cambria Math">Laporan Data Outlet</font></h2></center>  
  
 
  <font face="Cambria Math">
    <form action="cetakout.php">
...
<!--slider menu-->
    <div class="sidebar-menu">
        ...
        <div class="menu">
          <ul id="menu" >
            <li><a href="index3.php"><i class="fa fa-th-large"></i><span>Beranda</span></a></li>
