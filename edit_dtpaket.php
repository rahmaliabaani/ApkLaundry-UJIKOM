...
<div class="inner-block">
    <div class="blank">
    	<h2><font face="Cambria Math">Data Paket</font></h2>
    	<?php
  include 'koneksi.php';
  $kdp=$_GET['Kode_paket'];
  $query=mysqli_query($koneksi, "SELECT * FROM paket WHERE Kode_paket='$kdp'");
  while ($q = mysqli_fetch_array($query)) {
    ?>
       <form action="update_dtpaket.php" method="post">
              <font face="Cambria Math"> 
              <table class="table table-hover">
              <tr>
              <td>Kode Paket</td>
              <td><input type="text" size="20" name="Kode_paket" class="form-control" readonly="" value="<?php echo $q['Kode_paket'];?>"></td>
              </tr>  
              <tr>
              <td>Kode Outlet</td>
              <td><input type="text" name="Kode_outlet" size="20" placeholder="Masukan Kode" class="form-control" required="required" value="<?php echo $q['Kode_outlet'];?>"></td>
              </tr>  
              <tr>
              <td>Jenis</td>
              <td><select name="Jenis" class="form-control" required="">
                <option><?php echo $q['Jenis'];?></option>
              ...
              <tr>
              <td>Nama Paket</td>
              <td><input type="text" name="Nama_paket" size="20" placeholder="Masukan Nama" class="form-control" required="required" value="<?php echo $q['Nama_paket'];?>"></td>
              </tr>
              <tr>
              <td>Harga/Kg</td>
              <td><input type="number" name="Harga" size="20" placeholder="Masukan Harga" class="form-control" required="required" value="<?php echo $q['Harga'];?>"></td>
              </tr>  
              <tr>
