...
<font face="Cambria Math">
    ...
    while($d = mysqli_fetch_array($data)){
      ...
      <tr>
        ...
        <td>
          <a href="edit_member2.php?Kode_pel=<?php echo $d['Kode_pel']; ?>" onclick="return confirm('Apakah anda yakin edit?')"><i class='fa fa-edit'></i></a> |
           <a href="hapus_member2.php?Kode_pel=<?php echo $d['Kode_pel']; ?>" onclick="return confirm('Apakah anda yakin hapus?')"><i class='fa fa-trash-o'></i></a>
        </td>
      </tr>
	<?php 
    }
