  ...
  ?>
     <h2><font face="Cambria Math">Input Data Laundry</font></h2>
      ...
      include 'koneksi.php';
        ...
        $query=mysqli_query($koneksi, "SELECT * FROM paket WHERE Kode_paket='$kdpa'");
      while ($q = mysqli_fetch_array($query)) {
      ?>
      <form action="simpan_keranjang2.php" method="post">
              <div class="row">
                <div class="col-md-6">
      ...
      <?php
      include 'koneksi.php';
      $data=mysqli_query($koneksi,"SELECT Nama_pel FROM keranjang");
      while ($d = mysqli_fetch_array($data)) {
        ?>
              <td>Nama Pelanggan</td>
              <td><input type="text" id="Nama_pel" name="Nama_pel" class="form-control" readonly="" value="<?php echo $d['Nama_pel']; ?>"></td>
      <?php
      }
      ?>
      ...
      ?> 
              <td>Berat(Kg)</td>
              <td><input type="number" id="Jumlah" name="Jumlah" class="form-control" required="required"></td>
              ...
              <td>Subtotal</td>
              <td><input type="number" id="Subtotal" name="Subtotal" readonly="" class="form-control" required="required"></td>
