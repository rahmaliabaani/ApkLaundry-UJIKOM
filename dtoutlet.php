...
<div class="inner-block">
    <div class="blank">
      <?php
  include 'koneksi.php';
  $query = "SELECT max(Kode_outlet) AS maxKode FROM outlet";
  $hasil = mysqli_query($koneksi,$query);
  $data = mysqli_fetch_array($hasil);
  $kdout = $data['maxKode'];
  $nourut = (int)substr($kdout, 3, 3);
  $nourut++;

  $char = "KO-";
  $kdout = $char . sprintf("%03s", $nourut);
  ?>
    	<h2><font face="Cambria Math">Data Outlet</font></h2>
<div class="card">
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-header">
              <h4 class="modal-title"><font face="Cambria Math">Input data Outlet</font>
              <button type="button" class="close" data-dismiss="modal">&times;</button></h4>
            </div>
            <!-- body modal -->
            <div class="modal-body">
       <form action="simpan_dtoutlet.php" method="post">
              <font face="Cambria Math"> 
              <table class="table table-hover">
              <tr>
              <td>Kode Outlet</td>
              <td><input type="text" size="20" name="Kode_outlet" class="form-control" readonly="" value="<?php echo $kdout; ?>"></td>
              </tr>  
              <tr>
              <td>Nama Outlet</td>
              <td><input type="text" name="Nama_outlet" size="20" placeholder="Masukan Nama" class="form-control" required="required"></td>
              </tr>  
              <tr>
              <td>Alamat</td>
  ...
  <div class="col-md-9">
    ...
    if (isset($_GET['cari'])) {
       $cari = $_GET['cari'];
       $data = mysqli_query($koneksi, "SELECT * FROM outlet where Nama_outlet like '%$cari%' or Kode_outlet like '%$cari%'");
     } else {
    ...
    while($d = mysqli_fetch_array($data)){
      ...
      <tr>
        ...
        <td>
          <a href="edit_dtoutlet.php?Kode_outlet=<?php echo $d['Kode_outlet']; ?>" onclick="return confirm('Apakah anda yakin edit?')"><i class='fa fa-edit'></i></a> |
          <a href="hapus_dtoutlet.php?Kode_outlet=<?php echo $d['Kode_outlet']; ?>" onclick="return confirm('Apakah anda yakin hapus?')"><i class="fa fa-trash-o"></i></a>
        </td>
      </tr>
	<?php 
    }
