...
<div class="inner-block">
    <div class="blank">
      <?php
  include 'koneksi.php';
  $query = "SELECT max(Kode_p) AS maxKode FROM pegawai";
  $hasil = mysqli_query($koneksi,$query);
  $data = mysqli_fetch_array($hasil);
  $kdp = $data['maxKode'];
  $nourut = (int)substr($kdp, 3, 3);
  $nourut++;

  $char = "KP-";
  $kdp = $char . sprintf("%03s", $nourut);
  ?>
    	<h2><font face="Cambria Math">Data Pegawai</font></h2>
<div class="card">
      <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal"><i class="fa fa-user fa-fw"> +</i></button>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-header">
              <h4 class="modal-title"><font face="Cambria Math">Input data pegawai</font>
      ...
      <form action="simpan_pegawai.php" method="post">
              ...
              <tr>
              <td>Kode Pegawai</td>
              <td><input type="text" name="Kode_p" size="20" class="form-control" readonly="" value="<?php echo $kdp; ?>"></td>
              </tr> 
      ...
      ?>
              <td>Kode Outlet</td>
                <td><select name="Kode_outlet" class="form-control" required="">
                <?php while ($d = mysqli_fetch_array($data)) {?>
                  <option value="<?php echo $d['Kode_outlet']; ?>"><?php echo $d['Kode_outlet'];?></option>
                <?php } ?> 
                </select></td>

              <tr>
              <td>Nama Pegawai</td>
              <td><input type="text" name="Nama_p" size="20" placeholder="Masukan Nama" class="form-control" required="required"></td>
              </tr>
              <tr>
              <td>Username</td>
              <td><input type="text" name="Username" required="required" class="form-control" placeholder="Masukan Username"></td>
              </tr>
              <tr>
              <td>Password</td>
              <td><input type="password" name="Password" required="required" class="form-control" placeholder="Masukan Password"></td>
              </tr>
              <tr>
              <td>Jenis Kelamin</td>
              ...
              <tr>
              <td>Alamat</td>
              <td><input type="text" name="Alamat" placeholder="Masukan Alamat" class="form-control" required="required"></td>
              </tr>
              <tr>
              <td>No Telepon</td>
              ...
              <tr>
              <td>Status</td>
              <td><input type="text" name="Status"  class="form-control" required="required" value="Aktif" readonly=""></td>
              </tr>
              <tr>
              <td>Foto</td>
              <td><input type="file" name="Foto" class="form-control" required="required"></td>
              </tr>
              <tr>
...
<font face="Work Sans">
    ...
    while($d = mysqli_fetch_array($data)){
      ...
      <tr>
        ...
        <td>
          <a href="edit_pegawai.php?Kode_p=<?php echo $d['Kode_p']; ?>" onclick="return confirm('Apakah anda yakin edit?')"><i class='fa fa-edit fa-fw'></i></a>|
          <a href="hapus_pegawai.php?Kode_p=<?php echo $d['Kode_p']; ?>" onclick="return confirm('Pegawai akan di blokir?')"><i class="fa fa-gavel fa-fw"></i></a>
        </td>
      </tr>
      <?php 
    }
