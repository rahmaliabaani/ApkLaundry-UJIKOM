...
<body>
    <center>
  <center><h1>Laporan Data Omset</h1>
 ...
 <?php
    ...
    $tgl_akhir = $_POST['tgl_akhir'];
    $sts = $_POST['Status_p'];
    $query = mysqli_query($koneksi, "SELECT SUM(Total) as Omset FROM transaksi WHERE transaksi.Status_p='$sts' and transaksi.Tgl_dtg BETWEEN '$tgl_awal' AND '$tgl_akhir'");
    while($q = mysqli_fetch_array($query)){
    ?>
    <tr><td colspan="14">Total Omset : Rp. <?php echo number_format($q['Omset']); ?></td></tr>
    <?php
}
?>
