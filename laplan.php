...
<font face="Cambria Math">
  <div class="inner-block">
    <div class="blank">
      <center><h2><font face="Cambria Math">Laporan Paket Laundry</font></h2></center>  
  
 
  <font face="Cambria Math">
    <div class="row">
      <div class="col-md-2">
    <form action="cetaklan2.php">
        <a data-toggle="modal" data-target="#smallModal">
         <button class="btn btn-success"><i class="fa fa-print fa-fw"></i> Cetak Per-Outlet</button>
        </a>
        </form></div>
    <form action="cetaklan.php">
         <button class="btn btn-primary"><i class="fa fa-print fa-fw"></i> Cetak Semua</button>
        </form>
    </div>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="smallModalLabel">Laporan Paket Laundry</h4>
            </div>
            <div class="modal-body">
                <form method="POST" action="cetaklan2.php">
