...
<body>
  ...
  <table border="1" width="70%" style="border-collapse: collapse;">
    ...
    $tgl_akhir = $_POST['tgl_akhir'];
    $sts = $_POST['Status_p'];
    $query = mysqli_query($koneksi, "SELECT SUM(Total) as Pendapatan FROM transaksi WHERE transaksi.Status_p='$sts' and transaksi.Tgl_dtg BETWEEN '$tgl_awal' AND '$tgl_akhir'");
