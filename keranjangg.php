  ...
  <!-- <form action="tambah_trans.php"> -->
    ...
    while($d = mysqli_fetch_array($data)){
      ...
      <tr>
        ...
        <td>
        <a href="keranjanglagi.php?Kode_paket=<?php echo $d['Kode_paket']; ?>" class="btn btn-info"><i class="fa fa-shopping-bag"></i></a>
        </td>
        <?php 
        }    
        ?>
...
// error_reporting(E_ALL^E_NOTICE);
    ...
    while($d = mysqli_fetch_array($data)){
      ...
      <tr>
        ...
        <td>
        <a href="edit_keranjang.php?Kode_paket=<?php echo $d['Kode_paket']; ?>" onclick="return confirm('Apakah anda yakin edit?')"><i class='fa fa-edit fa-fw'></i></a>|
        <a href="hapus_keranjang.php?Kode_paket=<?php echo $d['Kode_paket']; ?>" onclick="return confirm('Apakah anda yakin hapus?')"><i class="fa  fa-trash-o fa-fw"></i></a>
        </td>
      </tr>
